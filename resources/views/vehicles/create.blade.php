            ...
            <div class="col-md-6">
                <div class="row mt-3 border rounded p-3 m-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="owner_contact" name="owner_contact" class="form-control" disabled
                            required>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="row mt-3 border rounded p-3 m-2">
                    ...
                    <div class="col">
                        ...
                        <input type="file" id="file" name="car_picture[]" class="form-control"
                            aria-label="Select pictures" multiple>
                    </div>
                </div>
            </div>
